...
"color: rgb(255, 255, 255);")
    ...
    def draw(self):
        ...
        sizes = [self.setToZero(booking),self.setToZero(canclebooking),self.setToZero(exitcar),self.setToZero(parkcar),self.setToZero(rto_payment)]
        print(sizes)
